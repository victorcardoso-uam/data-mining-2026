...
1. Baseline Model: Showed extreme overfitting with a Train R2 of 1.0 but a negative 
   Test R2 (-0.46), meaning the tree just memorized noise.
2. Pre-pruning: Successfully improved generalization. Candidate 1 achieved a positive 
   Test R2 (0.0088) by limiting depth and leaf size.
3. Cost-Complexity Pruning (CCP): Helped simplify the model to avoid the catastrophic 
   baseline error, confirming that pruning is essential for tree-based models 
   on this Amazon dataset.
"""