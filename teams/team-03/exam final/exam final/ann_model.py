...
#    Small network — 1 hidden layer, relu, more iterations with early stopping
# --------------------------------------------------

print("\n--- ANN Configuration A: (100,) | relu | max_iter=2000 | early_stopping=True ---")
ann_a = MLPRegressor(
...
metrics_a = evaluate("ANN — Config A: (100,) relu 2000 iter", y_test, pred_a)
print(f"  Converged: {ann_a.n_iter_ < ann_a.max_iter} | Iterations run: {ann_a.n_iter_}")

# --------------------------------------------------
# 7. ANN CONFIGURATION B
#    Larger network — 2 hidden layers, tanh, more iterations with early stopping
# --------------------------------------------------

print("\n--- ANN Configuration B: (100, 50) | tanh | max_iter=2000 | early_stopping=True ---")
ann_b = MLPRegressor(
...
metrics_b = evaluate("ANN — Config B: (100,50) tanh 2000 iter", y_test, pred_b)
...
print("\n--- ANN Configuration C: (128, 64, 32) | relu | max_iter=2000 | early_stopping=True ---")
ann_c = MLPRegressor(
