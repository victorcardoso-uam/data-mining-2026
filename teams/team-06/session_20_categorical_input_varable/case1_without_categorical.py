...
print(f"   R: {X_case1.columns.tolist()}")
print("2. Why was the categorical variable excluded? español")
print("   R: It was excluded because linear regression models require numeric inputs to perform mathematical calculations. In this first case, we wanted to establish a baseline performance using only the raw numeric data without applying any encoding to the text-based shift variable.")
print("3. Do you think excluding that variable may reduce performance? español")
print("   R: Likely yes, as different 'shifts' (Morning, Evening, Night) might have different production levels.")
