...
# Encode categorical variables (shift)
...
# =============================
# Transform input variables using polynomial features (degree=2)
...
# d) When is Polynomial Regression more appropriate?
print("\n=== TASK 2d: WHEN TO USE POLYNOMIAL REGRESSION ===")
print("""
Polynomial regression is more appropriate when the relationship between
the input variables and the target variable is non-linear (curved or parabolic).
If the data shows patterns such as diminishing returns, exponential growth,
or any shape that a straight line cannot capture, polynomial regression will
fit the data better. It is also preferred when linear regression underfits
the data (produces a low R2 score), as the polynomial transformation allows
the model to learn more complex patterns in the features.
In this exam dataset, if poly R2 > linear R2, it confirms the presence of
non-linear relationships that benefit from the degree-2 transformation.
""")
# Plot data, linear and polynomial regression
...
best_r2_value = models[best_model]

print(f"Best Model: {best_model}")
print(f"R2 Score: {best_r2_value:.4f}")

# c) Explanation of why this model performs best
print("\n=== TASK 4c: EXPLANATION ===")
print(f"\nThe {best_model} model performs best because:")
print(f"1. It achieves the highest R2 score of {best_r2_value:.4f}")
print(f"2. This means it explains {best_r2_value*100:.2f}% of the variance in production_efficiency_score")
