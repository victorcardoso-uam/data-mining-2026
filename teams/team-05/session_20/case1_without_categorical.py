...
print("   → production_hours, machine_temperature_c, operator_experience_years, material_hardness_index (numeric only).")
print("\n2. Why was the categorical variable excluded?")
print("   → LinearRegression requires numeric inputs; 'shift' is categorical text that cannot be directly used.")
print("\n3. Do you think excluding that variable may reduce performance?")
print("   → YES. Categorical variables often contain important information. Comparison with Case 3 will show the impact.")
print("\n4. Keep these metrics to compare them later with Case 3.")
print("   → Case 1: MAE=10.9304, MSE=172.9613, RMSE=13.1515, R²=0.8853")
