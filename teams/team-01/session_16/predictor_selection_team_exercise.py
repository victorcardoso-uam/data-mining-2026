...
DATA_PATH = r"C:\Users\ale03\OneDrive\Escritorio\MAYAB\SEMESTRE 8\MINERIA DE DATOS\data-mining-2026\teams\team-01\session_16\team01_inventory_replenishment_cost.csv"
...
def main() -> None:
    ...
    print("1. Which variables could be used as independent variables? Demand, lead time, holding cost")
    print("2. Which variables should be excluded? sku_code, transport_mode, order_quantity")
    print("3. Why do your selected variables make sense for predicting the target? Because they are directly related to the cost of replenishment. Demand affects how much inventory is needed, lead time impacts the timing and urgency of orders, and holding cost contributes to the overall cost structure. On the other hand, sku_code and transport_mode are more categorical and may not have a direct numerical relationship with the target variable, while order_quantity could be a result of demand rather than a predictor.")
    print("4. Would your answer change if the target variable were different? Yes, if the target variable were something like 'customer satisfaction', we might focus more on variables related to service quality or delivery times rather than cost-related variables.")
